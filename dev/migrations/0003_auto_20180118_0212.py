    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.CharField(
                ...
                max_length=10, null=True, unique=True, validators=[django.core.validators.RegexValidator(
        ...
        migrations.AlterField(
            model_name='extendsuser',
            name='user',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='extendsuser',
